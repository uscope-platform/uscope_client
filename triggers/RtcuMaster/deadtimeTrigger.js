function deadtime_trigger(parameters, context) {
    ...
    let low_side_turn_off = output_turn_on+parameters/4;
    let high_side_turn_on = output_turn_on-parameters/4;
    let high_side_turn_off = output_turn_off+parameters/4;
    let low_side_turn_on = output_turn_off-parameters/4;

...
import CoreInputProperties from "./CoreInputProperties.jsx";
import CoreOutputProperties from "./CoreOutputProperties.jsx";
import CoreMemoryProperties from "./CoreMemoryProperties.jsx";
import {up_emulator} from "#client_core/index.js";
import type {core, EmulatorComponentSelector, EmulatorIomSelector} from "#interfaces/index.js";

interface NodeIomPropertiesProps {
...
let  NodeIomProperties = (props: NodeIomPropertiesProps) =>{

...
interface ExternalInputPropertiesProps {
...
export let ExternalInputProperties = (props: ExternalInputPropertiesProps) =>{
    ...
    let handle_change_iom = (event: React.KeyboardEvent<HTMLInputElement>) =>{
        if(event.key==="Enter"|| event.key ==="Tab") {
            ...
            let value_tokens = raw_val.split(",")
            let value = value_tokens.map(val =>{

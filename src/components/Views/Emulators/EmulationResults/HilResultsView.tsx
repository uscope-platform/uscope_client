...
import {download_json, up_emulator_result} from "#client_core/index.js";

interface HilResultsViewProps {
    emulation_results: up_emulator_result,
    filename: string,
}

let HilResultsView = function (props: HilResultsViewProps) {
